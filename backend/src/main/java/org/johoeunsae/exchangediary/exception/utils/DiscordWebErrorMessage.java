...
@Builder
@Getter
public class DiscordWebErrorMessage {
	...
	public static DiscordWebErrorMessage fromHttpServletRequest(HttpServletRequest request,
			String subject,
			String responseBody) {
		String requestBody = "";
		...
		return DiscordWebErrorMessage.builder()
				.subject(subject)
	...
	public static DiscordWebErrorMessage fromWebRequest(WebRequest request, String subject,
			String responseBody) {
